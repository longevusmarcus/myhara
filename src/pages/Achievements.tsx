import { ArrowLeft, Sparkles, Target, Flame, Award, Trophy, Crown, Eye, Shield, Star, Lock } from "lucide-react";
...
const Achievements = () => {
  ...
  const allAchievements = [
    ...
    },
    {
      ...
      xp: 25,
      icon: Target,
      condition: { type: "checkins", value: 5 },
      progress: gamData.totalCheckins,
      color: "text-blue-500"
    },
    {
    ...
    },
    {
      ...
      xp: 50,
      icon: Eye,
      condition: { type: "checkins", value: 20 },
      progress: gamData.totalCheckins,
      color: "text-pink-500"
    },
    {
      ...
      xp: 100,
      icon: Shield,
      condition: { type: "checkins", value: 50 },
      progress: gamData.totalCheckins,
    ...
    },
    {
      ...
      xp: 250,
      icon: Star,
      condition: { type: "checkins", value: 100 },
      progress: gamData.totalCheckins,
