...
const LAUNCH_TIME = new Date('2026-02-13T00:00:00Z').getTime();
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto pt-16 md:pt-0">
          <motion.p
            ...
            className="text-xs md:text-sm tracking-[0.2em] md:tracking-[0.3em] uppercase text-muted-foreground/60 mb-8 md:mb-12"
          >
      ...
      <section id="manifesto" className="py-32 px-6">
        <div className="max-w-4xl mx-auto">
          <motion.p
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="text-center mb-16 text-xs md:text-sm tracking-[0.2em] md:tracking-[0.3em] uppercase text-muted-foreground/60"
          >
            Manifesto
          </motion.p>
